...
Um exemplo prático de aplicação da Capitalização Realizada é em relação ao mercado de criptomoedas. Ao compará-la com a capitalização de mercado convencional, podemos observar várias fases de mercado:
